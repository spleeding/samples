...
// STATE ARRAYS - Gamma 12MS | 40Hz - Beta 20MS | 25Hz - Mu 38.46MS | 13Hz - Alpha 41.66MS | 12Hz - Theta 100MS | 5Hz - Delta 250MS | 1Hz or 125MS | 4Hz 
...
// STATE WEIGHT ARRAYS
int GammaDist[6] = {10, 25, 45, 15, 5, 0};
int BetaDist[6] = {10, 25, 50, 5, 5, 5};
int MuDist[6] = {5, 10, 65, 10, 5, 5};
int AlphaDist[6] = {5, 15, 50, 15, 10, 5};
int ThetaDist[6] = {0, 15, 45, 20, 10, 10};
int DeltaDist[6] = {0, 5, 35, 25, 20, 15};

// WEIGTHED SELECTION FUNCTION
...
void loop() {
  ...
  for (int i = 0; i < 24; i++){
    ring.setPixelColor(0, 255, 255, 255); // there was a bug where it wouldn't register the 0 in the iteration, therefore it is specified here.
  ...
  delay(Freq);
  for (int i = 0; i < 24; i++){
    ring.setPixelColor(0, 0, 0, 0); // there was a bug where it wouldn't register the 0 in the iteration, therefore it is specified here.
