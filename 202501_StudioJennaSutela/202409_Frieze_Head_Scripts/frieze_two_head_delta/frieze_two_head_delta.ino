...
int GammaDist[6] = {10, 10, 15, 15, 15, 35};
int BetaDist[6] = {5, 10, 15, 15, 15, 40};
int MuDist[6] = {5, 5, 10, 15, 20, 45};
int AlphaDist[6] = {0, 5, 10, 10, 20, 55};
int ThetaDist[6] = {0, 5, 5, 10, 15, 65};
int DeltaDist[6] = {0, 0, 5, 5, 15, 75};
